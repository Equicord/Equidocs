...
> [!NOTE]
> Unless you're a developer, there's no reason to build from source. To use **user plugins** or **dev builds**, simply clone **Equicord** instead. More details [on Equibop wiki](https://equibop.org/wiki/linux/dev-build/).
